CREATE OR REPLACE VIEW VW_METER_INFO  AS SELECT MTR.*,MN.MANF_DESCR,MN.MANF_DESCR_B  FROM TBL_METER MTR LEFT JOIN TBL_MANUFACTURERS MN ON MTR.MANF_CODE=MN.MANF_CODE;


CREATE OR REPLACE VIEW VW_CMO_NEW
 AS SELECT CMO_ID, CMO_DATE, APP_TRK_NO, SRNO, CMO.CUST_ID, CMO.ELAKA_CODE, CMO.BOOK_CODE, CMO.ACCOUNT_NUM, 
CUST_NAME, CUST_ADDRESS, MS_KHATIAN, MS_DAGG, MS_MOJA, CMO_DISTRICT, CMO_SUB_DISRTRICT, CMO_UNION, CMO_VILLAGE, 
CMO_PO, PO_CODE, SPL_REMARKS, CMO_COMPLETE_DATE, EFF_PERIOD, WIR_INS_ID, WIR_DATE, PHASE, FSB_ID, FSB_DATE, MBR_SHIP_ID, 
MBR_SHIP_NO, CONNECTED_LOAD, X_ID, X_FORMER_POLE, X_FORMER_LOAD, SUBSTATION_ID, FEEDER_ID, FSB_OR_ID, DEPOSIT_OR_ID, 
CMO_STATUS, CMO_PREPARED_BY, CMO_BILLING_BY, CMO_CONFIRMED_BY, CMO_TYPE, IS_INSTALL, IS_CONNECT, IS_REMOVE, IS_DISCONNECT, 
CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REC_STATUS, CONN_DATE, CONN_METER_ID, CONN_METER_NO, CONN_METER_DEGIT, 
CON_METER_SEAL_NO, CONN_METER_TYPE, CONN_METER_VOLTAGE, CONN_LOAD, CONN_BY, CONN_MF, CONN_PF, CONN_READING, 
...
CI.CUST_ID, REF_CUSTOMER_NUM, OFFICE_CODE, ELAKA_CODE, 
...
G_DIST_CODE, G_SD_CODE, G_UNION_CODE, G_VILL_CODE, 
...
SEASON_START_MONTH, EFF_BILL_PERIOD, MIN_OWNER_CODE, MIN_ORG_CODE, 
EBA_X, REC_STATUS, CREATE_BY, CREATE_DATE, 
UPDATE_BY, UPDATE_DATE, MBR_SHIP_DATE, MBR_PICTURE, 
MBR_NON_VOTER, SPL_REBATE_OFFPK_UNIT, MBR_SHIP_SR_NO_SPL, MBR_SHIP_SR_NO, 
PF_MSR_DATE, CUST_METER_ID, AVG_UNIT, SUBSTATION_ID, 
FEEDER_ID, X_ID, X_SERIAL, NEAREST_POLE, 
...
MSC.LEGAL_OWNER, MSC.MOUZA_B, MSC.MOUZA, MSC.DAGG_NO, MSC.POLE_DIST, MSC.SPL_INFO, MSC.MSC.MOBILE_NO_1, MSC.MOBILE_NO_2 FROM TBL_CUSTOMER_INTERFACE  CI
